...
const SocialLoading = () => {
    useEffect(() => {
        const handleScroll = () => {
          ...
          // Show after 10% scroll, hide again at last 10%
    ...
    return (
        <StyledWrapper>
            <div className="card-left">
                {/* Instragram */}
                <a 
                href="https://www.instagram.com/the.anuraganand/profilecard/?igsh=MTN2YmV1aW5ud3pmaw%3D%3D" 
                target="_blank"
                rel='noreferrer' 
                className="socialContainer containerOne top-right-side-border">
                ...
                {/* Twitter */}
                <a href="https://www.facebook.com/" target="_blank" rel='noreferrer' className="socialContainer containerTwo">
                ...
                {/* Linkdin */}
                <a href="https://www.facebook.com/" target="_blank" rel='noreferrer' className="socialContainer containerThree">
                ...
                {/* Whatsapp */}
                <a href="https://www.facebook.com/" target="_blank" rel='noreferrer' className="socialContainer containerFour bottom-right-side-border">
